...
function updateCombatDisplay() {
    ...
    document.getElementById("hero-mana").innerHTML = character.currentMana + " / " + character.maxMana
    ...
    document.getElementById("enemy-health").innerHTML = currentEnemy.currentHealth + " / " + currentEnemy.health
